...
RDS_DB_MYSQL_IMPORT_SCRIPT_WMS = config['RDS']['RDS_DB_MYSQL_IMPORT_SCRIPT_WMS'] # Pfad zum SQL-Skript
RDS_DB_MYSQL_IMPORT_SCRIPT_DWH = config['RDS']['RDS_DB_MYSQL_IMPORT_SCRIPT_DWH'] # Pfad zum SQL-Skript
...
if __name__ == "__main__":
    ...
    script_path_wms = RDS_DB_MYSQL_IMPORT_SCRIPT_WMS

    run_sql_script(host, user, password, database, script_path_wms)
