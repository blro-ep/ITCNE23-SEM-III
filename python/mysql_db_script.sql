...
-- -----------------------------------------------------
-- Table `mydb`.`statuscode`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`statuscode` (
  `id_statuscode` INT NOT NULL AUTO_INCREMENT,
  `code_type` INT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`benutzer` (
  ...
  CONSTRAINT `fk_benutzer_1`
    ...
    REFERENCES `mydb`.`statuscode` (`id_statuscode`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`artikel` (
  ...
  INDEX `fk_artikel_1_idx` (`ref_status` ASC) VISIBLE,
  CONSTRAINT `fk_artikel_1`
    FOREIGN KEY (`ref_status`)
    REFERENCES `mydb`.`statuscode` (`id_statuscode`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`lieferschein` (
  `id_lieferschein` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `mydb`.`lieferschein_position` (
  `id_lieferschein_position` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `mydb`.`seriennummer` (
  `id_seriennummer` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `mydb`.`behaelter` (
  `id_behaelter` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `mydb`.`behaelter_position`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`behaelter_position` (
  `id_behaelter_position` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `mydb`.`lagerplatz` (
  `id_lagerplatz` INT NOT NULL AUTO_INCREMENT,
  `ref_artikel` INT NULL,
